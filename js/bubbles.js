...
function drawName(name, letterColors) {
    ...
    for (var j = 0; j < g.length; j++) {
        ...
        g[j].curPos.y = (canvasHeight / 2 - y_shift) + g[j].curPos.y;
        g[j].originalPos.x = (canvasWidth / 2 - offset / 2) + g[j].originalPos.x;
        g[j].originalPos.y = (canvasHeight / 2 - y_shift) + g[j].originalPos.y;
    }
...
document.rotationForce = 0.1;
document.Friction = 0.50;
